...
# kedro_node_order documentation build
...
from kedro_node_order import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_node_order"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_node_orderdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_node_order.tex",
        "kedro_node_order Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_node_order",
        "Project kedro_node_order codebase.",
        "Data-Science",
    )
]
