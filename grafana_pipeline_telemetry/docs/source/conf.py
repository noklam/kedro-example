...
# grafana_pipeline_telemetry documentation build
...
from grafana_pipeline_telemetry import __version__ as release

# -- Project information -----------------------------------------------------

project = "grafana_pipeline_telemetry"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "grafana_pipeline_telemetrydoc"
...
latex_documents = [
    (
        master_doc,
        "grafana_pipeline_telemetry.tex",
        "grafana_pipeline_telemetry Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "grafana_pipeline_telemetry",
        "Project grafana_pipeline_telemetry codebase.",
        "Data-Science",
    )
]
