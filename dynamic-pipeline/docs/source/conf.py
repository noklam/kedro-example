...
# dynamic_pipeline documentation build
...
from dynamic_pipeline import __version__ as release
...
htmlhelp_basename = "dynamic_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "dynamic_pipeline.tex",
        "dynamic_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "dynamic_pipeline",
        "Project dynamic_pipeline codebase.",
        "Nearest-Neighbour",
    )
]
