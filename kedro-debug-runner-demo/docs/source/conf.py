...
# kedro_debug_runner_demo documentation build
...
from kedro_debug_runner_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_debug_runner_demo"
author = "Kedro"
...
htmlhelp_basename = "kedro_debug_runner_demodoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_debug_runner_demo.tex",
        "kedro_debug_runner_demo Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_debug_runner_demo",
        "Project kedro_debug_runner_demo codebase.",
        "Nearest-Neighbour",
    )
]
