...
# nested_resolver documentation build
...
from nested_resolver import __version__ as release

# -- Project information -----------------------------------------------------

project = "nested_resolver"
author = "Kedro"
...
htmlhelp_basename = "nested_resolverdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "nested_resolver",
        "Project nested_resolver codebase.",
        "Nearest-Neighbour",
    )
]
