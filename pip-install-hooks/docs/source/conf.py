...
# pip_install_hooks documentation build
...
from pip_install_hooks import __version__ as release

# -- Project information -----------------------------------------------------

project = "pip_install_hooks"
author = "Kedro"
...
htmlhelp_basename = "pip_install_hooksdoc"
...
latex_documents = [
    (
        master_doc,
        "pip_install_hooks.tex",
        "pip_install_hooks Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pip_install_hooks",
        "Project pip_install_hooks codebase.",
        "Data-Science",
    )
]
