...
# kedro_cli_extension documentation build
...
from kedro_cli_extension import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_cli_extension"
author = "Kedro"
...
htmlhelp_basename = "kedro_cli_extensiondoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_cli_extension.tex",
        "kedro_cli_extension Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_cli_extension",
        "Project kedro_cli_extension codebase.",
        "Data-Science",
    )
]
