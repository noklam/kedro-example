...
# log_dataset_version documentation build
...
from log_dataset_version import __version__ as release

# -- Project information -----------------------------------------------------

project = "log_dataset_version"
author = "Kedro"
...
htmlhelp_basename = "log_dataset_versiondoc"
...
latex_documents = [
    (
        master_doc,
        "log_dataset_version.tex",
        "log_dataset_version Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "log_dataset_version",
        "Project log_dataset_version codebase.",
        "Nearest-Neighbour",
    )
]
