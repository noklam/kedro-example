...
# jupyter_debug_demo documentation build
...
from jupyter_debug_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "jupyter_debug_demo"
author = "Kedro"
...
htmlhelp_basename = "jupyter_debug_demodoc"
...
latex_documents = [
    (
        master_doc,
        "jupyter_debug_demo.tex",
        "jupyter_debug_demo Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "jupyter_debug_demo",
        "Project jupyter_debug_demo codebase.",
        "Nearest-Neighbour",
    )
]
