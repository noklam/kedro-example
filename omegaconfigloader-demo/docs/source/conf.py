...
# omegaconfigloader_demo documentation build
...
from omegaconfigloader_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "omegaconfigloader_demo"
author = "Kedro"
...
htmlhelp_basename = "omegaconfigloader_demodoc"
...
latex_documents = [
    (
        master_doc,
        "omegaconfigloader_demo.tex",
        "omegaconfigloader_demo Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "omegaconfigloader_demo",
        "Project omegaconfigloader_demo codebase.",
        "Nearest-Neighbour",
    )
]
