...
# loop_pipeline documentation build
...
from loop_pipeline import __version__ as release
...
htmlhelp_basename = "loop_pipelinedoc"
...
texinfo_documents = [
    (
        ...
        author,
        "loop_pipeline",
        "Project loop_pipeline codebase.",
        "Nearest-Neighbour",
    )
]
