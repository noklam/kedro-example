...
# template_config_loader_demo documentation build
...
from template_config_loader_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "template_config_loader_demo"
author = "Kedro"
...
htmlhelp_basename = "template_config_loader_demodoc"
...
latex_documents = [
    (
        master_doc,
        "template_config_loader_demo.tex",
        "template_config_loader_demo Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "template_config_loader_demo",
        "Project template_config_loader_demo codebase.",
        "Nearest-Neighbour",
    )
]
