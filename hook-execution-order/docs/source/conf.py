...
# hook_execution_order documentation build
...
from hook_execution_order import __version__ as release

# -- Project information -----------------------------------------------------

project = "hook_execution_order"
author = "Kedro"
...
htmlhelp_basename = "hook_execution_orderdoc"
...
latex_documents = [
    (
        master_doc,
        "hook_execution_order.tex",
        "hook_execution_order Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "hook_execution_order",
        "Project hook_execution_order codebase.",
        "Nearest-Neighbour",
    )
]
