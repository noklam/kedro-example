...
# stresstest_pipeline documentation build
...
from stresstest_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "stresstest_pipeline"
author = "Kedro"
...
htmlhelp_basename = "stresstest_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "stresstest_pipeline.tex",
        "stresstest_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "stresstest_pipeline",
        "Project stresstest_pipeline codebase.",
        "Data-Science",
    )
]
