...
# kedro_jupyter_dev documentation build
...
from kedro_jupyter_dev import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_jupyter_dev"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_jupyter_devdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_jupyter_dev.tex",
        "kedro_jupyter_dev Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_jupyter_dev",
        "Project kedro_jupyter_dev codebase.",
        "Data-Science",
    )
]
