...
# stress_test_pipeline documentation build
...
from stress_test_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "stress_test_pipeline"
author = "Kedro"
...
htmlhelp_basename = "stress_test_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "stress_test_pipeline.tex",
        "stress_test_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "stress_test_pipeline",
        "Project stress_test_pipeline codebase.",
        "Nearest-Neighbour",
    )
]
