...
# partitioned_dataset documentation build
...
from partitioned_dataset import __version__ as release

# -- Project information -----------------------------------------------------

project = "partitioned_dataset"
author = "Kedro"
...
htmlhelp_basename = "partitioned_datasetdoc"
...
latex_documents = [
    (
        master_doc,
        "partitioned_dataset.tex",
        "partitioned_dataset Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "partitioned_dataset",
        "Project partitioned_dataset codebase.",
        "Nearest-Neighbour",
    )
]
