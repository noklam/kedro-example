...
# read_sql_template_resolver documentation build
...
from read_sql_template_resolver import __version__ as release

# -- Project information -----------------------------------------------------

project = "read_sql_template_resolver"
author = "Kedro"
...
htmlhelp_basename = "read_sql_template_resolverdoc"
...
latex_documents = [
    (
        master_doc,
        "read_sql_template_resolver.tex",
        "read_sql_template_resolver Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "read_sql_template_resolver",
        "Project read_sql_template_resolver codebase.",
        "Data-Science",
    )
]
